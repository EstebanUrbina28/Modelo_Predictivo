        ...
        while($arr = mysqli_fetch_array($consulta)){
         ...
         <div class='right_col' role='main'>
          ...
          <div class='tile_count'>
            ...
            ";}
            $SQL1= "SELECT COUNT(*) FROM not_lec";
            ...
            ";}
            $SQL2= "SELECT resultado,COUNT(resultado) FROM not_lec WHERE resultado LIKE '%SI%'";                               
            ...
            <div class='col-md-2 col-sm-4  tile_stats_count'>
              ...
              <span class='count_bottom'><i class='red'><i class='fa fa-sort-asc'></i>$arr2[0] </i> Deserto </span>
            </div>
            ";}
            $SQL3= "SELECT resultado,COUNT(resultado) FROM not_lec WHERE resultado LIKE '%NO%'";                               
            // con control D selecionamos y remplazamos
            ...
            <div class='col-md-2 col-sm-4  tile_stats_count'>
              ...
              <span class='count_bottom'><i class='green'><i class='fa fa-sort-desc'></i>$arr3[0] </i> Deserto </span>
            </div>
            ";}
            $SQL4= "SELECT COUNT(jornada) FROM not_lec WHERE jornada LIKE 'Diu%'";                               
            // con control D selecionamos y remplazamos
            ...
            ";}
            $SQL5= "SELECT COUNT(jornada) FROM not_lec WHERE jornada LIKE 'Noc%'";                               
            // con control D selecionamos y remplazamos
            ...
            <div class="col">
              <div class="x_panel tile fixed_height_320">
                <div class="x_title">
                  ...
                  <form action="cal_treeco.php" method="POST"  >
                  <div class="clearfix"></div>
                  </div>
                  <div class="row ">
