...
<html lang="en">
  ...
  <body class="nav-md">
        ...
        while($arr = mysqli_fetch_array($consulta)){
         ...
         <div class='right_col' role='main'>
          ...
          <div class='tile_count'>
            ...
            ";}
            $SQL1= "SELECT COUNT(*) FROM notas_mat";
            ...
            ";}
            $SQL2= "SELECT resultado,COUNT(resultado) from notas_mat WHERE resultado < 3";                               
            ...
            ";}
            $SQL3= "SELECT resultado,COUNT(resultado) from notas_mat WHERE resultado >= 3";                               
            // con control D selecionamos y remplazamos
            ...
            ";}
            $SQL4= "SELECT COUNT(jornada) FROM notas_mat WHERE jornada LIKE 'Diu%'";                               
            // con control D selecionamos y remplazamos
            ...
            ";}
            $SQL5= "SELECT COUNT(jornada) FROM notas_mat WHERE jornada LIKE 'Noc%'";                               
            // con control D selecionamos y remplazamos
              ...
              <div class="modal fade" id="myModal">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <p>ESTE APLICATIVO WEB CUENTA CON INFORMACIÓN RELEVANTE DE LA UNIVERSIDAD CESMAG, LA INFORMACIÓN SUMINISTRADA EN EL APLICATIVO, LE RECOMENDAMOS QUE SEA CLARA Y CONSIENTE PARA OBTENER RESULTADOS REALES. EL APLICATIVO CUENTA CON MODELOS AUTOMATIZADOS Y GRÁFICOS PARA CONOCER LA INFORMACIÓN, TENGA EN CUENTA LA IMPORTANCIA DE INGRESAR DATOS REALES PUESTO QUE LOS MODELOS DEPENDEN DE LA INFORMACIÓN INGRESADA PARA OBTENER UN ENTRENAMIENTO ÓPTICO. FINAL MENTE RECOMENDAMOS EL MODELO DE REGRESIÓN LINEAL PUESTO QUE TIENE UN ALTO GRADO DE CONFIABILIDAD.  . 
                    </p>
                    </div>

                    <!-- Modal footer -->
                    <div class="modal-footer">
                    <p>RECUERDE ANTES DE CERRAR SESIÓN REALICE LA ENCUESTA DE SATISFACCIÓN GRACIAS </p>
                    </div>
    ...
    <script src="../build/css/estilos.css"></script>
