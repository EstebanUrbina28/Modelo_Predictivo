...
$bd  = conectar(); 
$SQL= "SELECT nota1,nota2,nota3,saber11,ano_lec,jornada,resultado FROM not_lec";
//var_dump($SQL);exit;
...
foreach ($testingLabels as $i => $label) {
  ...
  //var_dump($promedio_matematicas);exit;
            ...
            $sql = "insert into not_lec values('.',$n1,$n2,$n3,$n4,'$ano','$jornada','$predictedLabels[0]')";
            $res = mysqli_query($bd,$sql);
            if ($res){
                 echo ' <div class="alert alert-info">
                <strong>Info!</strong> Registro Adicionado 
              </div>';
               echo '<a href="com_tree.php" class="btn btn-primary">Vover al Modulo</a>';
              ...
              <div class="modal fade" id="myModal">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    Predicion : ' . $predictedLabels[0] . ' DESERTA <br>
