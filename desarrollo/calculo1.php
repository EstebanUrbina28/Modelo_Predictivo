  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Modelo De Regresion Multiple <span class="fa fa-chevron-down"></span></a>
        ...
        <center><h1> Resultados Modulo Comunicacion Oral y Escrita </h1> </center>
...
$bd  = conectar(); 
$SQL= "SELECT com_oral1,com_orl2,com_orl3,resultado from notas_lec";
//var_dump($SQL);exit;
...
// se captura datos de entrada    
    ...
    $predictedPrice = $regression->predict([[$n1,$n2,$n3,$n4]]);
  ...
  //echo $redondeado; // Mostrará 3.14
    ...
    echo '<br>' ;                   
            ...
            $sql = "insert into notas_lec values('.',$n1,$n2,$n3,$n4,'$año','$jornada',$redondeado)";
            $res = mysqli_query($bd,$sql);
            if ($res){
                 echo ' <div class="alert alert-info">
                <strong>Info!</strong> Registro Adicionado 
              </div>';
              echo '<a href="index2.php" class="btn btn-primary">Vover al registro</a>';
            }
            else{
           
                echo "<div class='alert alert-danger'>
                <strong>Alerta!</strong> Registro No Adicionado 
            ...
            <div class="modal fade" id="myModal">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  Coeficiente Coeficiente de correlación múltiple: : ' . $corr_coeff.'<br>
